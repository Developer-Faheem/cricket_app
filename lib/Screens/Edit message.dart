...
class Editmesaage extends StatelessWidget {
  const Editmesaage({super.key});
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text("Your event has been edited.",style: TextStyle(color: Color(0xffFFFFFF),fontSize: 20,fontWeight: FontWeight.w400),),
                ),
